...
export const syncStatusDetail = document.getElementById('sync-status-detail') as HTMLDivElement;
...
export const quoteCityContainer = document.getElementById('quote-city-container') as HTMLDivElement;
export const quoteCitySelect = document.getElementById('quote-city-select') as HTMLSelectElement;
export const quoteSedeContainer = document.getElementById('quote-sede-container') as HTMLDivElement;
export const quoteSedeSelect = document.getElementById('quote-sede-select') as HTMLSelectElement;
export const quoteAddSedeBtn = document.getElementById('quote-add-sede-btn') as HTMLButtonElement;
export const quoteEditSedeBtn = document.getElementById('quote-edit-sede-btn') as HTMLButtonElement;
...
export const quoteInternalNotesTextarea = document.getElementById('quote-internal-notes-textarea') as HTMLTextAreaElement;
...
export const ordersRefreshBtn = document.getElementById('orders-refresh-btn') as HTMLButtonElement;
...
export const orderDifficultySelect = document.getElementById('order-difficulty') as HTMLSelectElement;
export const orderDurationHint = document.getElementById('order-duration-hint') as HTMLDivElement;
...
export const technicianSelectorPlaceholder = document.querySelector('#technician-selected-pills .custom-select-placeholder') as HTMLSpanElement;
export const orderTypeSelectorPlaceholder = document.querySelector('#order-type-selected-pills .custom-select-placeholder') as HTMLSpanElement;
...
export const orderCityContainer = document.getElementById('order-city-container') as HTMLDivElement;
export const orderCitySelect = document.getElementById('order-city-select') as HTMLSelectElement;
export const orderSedeContainer = document.getElementById('order-sede-container') as HTMLDivElement;
export const orderSedeSelect = document.getElementById('order-sede-select') as HTMLSelectElement;
export const orderAddSedeBtn = document.getElementById('order-add-sede-btn') as HTMLButtonElement;
export const orderEditSedeBtn = document.getElementById('order-edit-sede-btn') as HTMLButtonElement;
...
export const orderAnnexPreviewContainer = document.getElementById("order-annex-preview-container") as HTMLDivElement;
...
export const orderTypeSelector = document.getElementById('order-type-selector') as HTMLDivElement;
export const orderTypeSelectedPills = document.getElementById('order-type-selected-pills') as HTMLDivElement;
export const orderTypeDropdown = document.getElementById('order-type-dropdown') as HTMLDivElement;
...
export const savedQuotesRefreshBtn = document.getElementById('saved-quotes-refresh-btn') as HTMLButtonElement;
...
export const clientsRefreshBtn = document.getElementById('clients-refresh-btn') as HTMLButtonElement;
...
export const itemsRefreshBtn = document.getElementById('items-refresh-btn') as HTMLButtonElement;
...
export const techniciansRefreshBtn = document.getElementById('technicians-refresh-btn') as HTMLButtonElement;
...
export const reportsTechFilter = document.getElementById('reports-tech-filter') as HTMLSelectElement;
export const reportsCityFilter = document.getElementById('reports-city-filter') as HTMLSelectElement;
