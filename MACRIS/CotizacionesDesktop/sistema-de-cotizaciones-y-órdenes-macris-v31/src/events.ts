...
function setupManagementEventListeners() {
    ...
    D.clientsRefreshBtn?.addEventListener('click', () => UI.handleClientsManualRefresh(D.clientsRefreshBtn));
    ...
    D.itemsRefreshBtn?.addEventListener('click', () => UI.handleItemsManualRefresh(D.itemsRefreshBtn));
    ...
    D.savedQuotesRefreshBtn?.addEventListener('click', () => UI.handleSavedQuotesManualRefresh(D.savedQuotesRefreshBtn));
    ...
    D.ordersRefreshBtn?.addEventListener('click', () => UI.handleOrdersManualRefresh(D.ordersRefreshBtn));
    ...
    D.techniciansRefreshBtn?.addEventListener('click', () => UI.handleTechniciansManualRefresh(D.techniciansRefreshBtn));
