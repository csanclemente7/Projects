...
export const editReportCitySelect = document.getElementById('edit-report-city') as HTMLSelectElement;
export const editReportSedeSelect = document.getElementById('edit-report-sede') as HTMLSelectElement;
...
export const orderServicesTableBody = document.getElementById('order-services-list') as HTMLElement;
